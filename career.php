  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="mainNav">
      <ul class="navbar-nav ms-auto text-uppercase">
        ...
        <li class="nav-item"><a href="https://rvnssolutionspvtltd.in/career.php" class="nav-link active">Career</a></li>
        <li class="nav-item"><a href="https://rvnssolutionspvtltd.in/feedback.php" class="nav-link">FAQ</a></li>
...
<div class="col-12 col-md-3 text-center text-md-start">
  ...
  <p><i class="bi bi-telephone-fill me-2"></i>
    <a href="tel:+918247026944" class="footer-link text-light text-decoration-none">+91 8247026944</a>
  </p>
  <p class="mb-0">
    ...
    <a href="mailto:rvnssolutions@gmail.com" class="footer-link text-light text-decoration-none"
      ...
      <div class="col-12 col-md-3 text-center text-md-start">
        ...
        <div class="social-icons mt-3 d-flex justify-content-center justify-content-md-start gap-3" style="font-size: 1.2rem;">
          <a href="https://www.facebook.com/share/1YvMWSFs6M/" aria-label="Facebook" class="text-light;" target="_blank"><i class="bi bi-facebook"></i></a>
          <a href="https://x.com/rvnssolutions?t=0483Kkxv4J7BLPZRRg4ryg&s=08" aria-label="Twitter" class="text-light" target="_blank"><i class="bi bi-twitter"></i></a>
          <a href="https://www.instagram.com/rvns_solutions?igsh=aGpwazMzZTlzMjUy" aria-label="Instagram" class="text-light" target="_blank"><i class="bi bi-instagram"></i></a>
          <a href="https://www.linkedin.com/in/rvns-solutions-pvt-ltd-8a5278383" aria-label="LinkedIn" class="text-light" target="_blank"><i class="bi bi-linkedin"></i></a>
          <a href="https://youtube.com/@rvns-solutions?si=_4U5xgGO_9LJ9Lsr" aria-label="YouTube" class="text-light" target="_blank"><i class="bi bi-youtube"></i></a>
          <a href="https://wa.me/918247026944" aria-label="WhatsApp" class="text-light" target="_blank"><i class="bi bi-whatsapp"></i></a>
        </div>
      </div>
    </div>
    <div class="text-center text-light small mt-4" style="opacity: 0.65;">
      ...
      <p class="mt-2 mb-0">
  © 2024–<span id="year"></span> RVNS Solutions. All rights reserved.
</p>
